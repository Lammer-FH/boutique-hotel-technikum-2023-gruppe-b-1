<template>
        ...
        <div id="content">
            <b-container class="card-container">
                <b-card-group>
                    <b-card img-src="src\assets\restaurant.jpg" img-height="400px" img-alt="Restaurant" img-top border-variant="secondary"
                            header="Unser Restaurant" header-border-variant="secondary" align="center">
                        <b-card-text>
                            In unserem prämierten Restaurant können Sie den Tag gemütlich bei einem Dinner ausklingen lassen. Die Küche ist regional und saisonal, vegetarische und vegane Optionen sind selbstverständlich verfügbar. Ob á la Carte oder 5-Gänge-Menü mit Weinbegleitung: hier kommt jede und jeder auf seine Kosten.
                            Die Einrichtung ist exquisit und geschmackvoll, das Personal exzellent ausgebildet. Lassen Sie sich verwöhnen vom eleganten Ambiente, von erlesenen Speisen und von der großen Auswahl an außergewöhnlichen Getränken.
                        </b-card-text>
                    </b-card>

                    <b-card img-src="src\assets\wellness02.jpg" img-alt="Wellnessbereich" img-height="400px" img-top border-variant="secondary"
                            header="Der Wellnessbereich" header-border-variant="secondary" align="center">
                        <b-card-text>
                ...
                <br />
                <b-row>
                    <b-card img-src="src\assets\wellness.jpg" img-alt="Unser Wellnessbereich" img-top border-variant="secondary" 
                            header="Der Wellnessbereich" header-border-variant="secondary" align="center">
                        <b-card-text>
